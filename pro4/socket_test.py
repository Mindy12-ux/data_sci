...
print(socket.getservbyname('https', 'tcp'))     # 443 / www
...
#           주소 체계 <> ,  소켓 타입(0)  , 프로토콜 번호(6) , 실제 접속 주소 ()

print(socket.getaddrinfo('www.naver.com', 443, proto= socket.SOL_TCP))
# [(<AddressFamily.AF_INET: 2>, 0, 6, '', ('223.130.192.248', 443)), 
# (<AddressFamily.AF_INET: 2>, 0, 6, '', ('223.130.200.219', 443)), 
# (<AddressFamily.AF_INET: 2>, 0, 6, '', ('223.130.200.236', 443)), 
# (<AddressFamily.AF_INET: 2>, 0, 6, '', ('223.130.192.247', 443))]
